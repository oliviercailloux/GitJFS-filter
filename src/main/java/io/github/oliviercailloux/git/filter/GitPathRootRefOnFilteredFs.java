...
/**
 * Similar to a {@link GitPathRootRef} (which it wraps and delegates to) except linked to a
 * filteredFs.
 */
final class GitPathRootRefOnFilteredFs extends ForwardingGitPathRootRef
