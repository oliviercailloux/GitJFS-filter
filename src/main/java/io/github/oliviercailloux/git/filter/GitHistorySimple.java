 ...
 * associated date.
 * <p>Longer term improvement: we’d better traficate the commit itself to change its date if we prefer the push date (or any other source), and let clients use always the commit date. Then this class would serve to filter a gitfs according to the commit date.
 * <p>
